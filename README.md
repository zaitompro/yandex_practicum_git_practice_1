...
git branch -d branch_name # Безопасное удаление указанной ветки с предварительной проверкой того, что в ветке нет эксклюзивных изменений, отсутствующих в других ветках
```
